...
const ownerMethods = [
  ...
  "library.archive_begin", "library.archive_append", "library.archive_complete", "library.archive_cancel",
  "library.archive_status", "library.archive_list", "library.archive_search", "library.archive_read",
  "admin.export", "admin.archive_delete", "admin.approve_archive_access", "admin.diagnostics", "admin.prepare_client_rotation",
