...
const METHODS = {
  ...
  "library.archive_begin": ["owner-control", "library.execute"],
  "library.archive_append": ["owner-control", "library.execute"],
  "library.archive_complete": ["owner-control", "library.execute"],
  "library.archive_cancel": ["owner-control", "library.execute"],
  "library.archive_status": ["owner-control", "library.execute"],
  "library.archive_list": ["owner-control", "library.execute"],
  "library.archive_search": ["owner-control", "library.execute"],
  "library.archive_read": ["owner-control", "library.execute"],
  "admin.export": ["owner-control", "admin.begin"],
  "admin.archive_delete": ["owner-control", "admin.begin"],
  "admin.approve_archive_access": ["owner-control", "admin.begin"],
