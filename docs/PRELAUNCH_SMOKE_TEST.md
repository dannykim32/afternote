...
Run this against the signed and notarized **2.0.0-alpha.26** candidate containing local
...
explicit installation, ordinary paraphrase and exact search, first search after relaunch,
lock/revocation during search, and interrupted setup recovery. Use the same synthetic notes
